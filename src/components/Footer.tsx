...
export default function Footer() {
  return (
    <footer className="relative bg-blue-deep text-white overflow-hidden">
      {/* Grain texture */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 text-sm max-w-sm leading-relaxed">
              A curated lifestyle platform blending movement, wellbeing, and
              social connection into meaningful, premium experiences.
            </p>
            <p className="mt-6 text-xs text-white/40 tracking-wide uppercase">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-white/40">
            &copy; {new Date().getFullYear()} ILEA &mdash; International Leading Education Alliance.
            All rights reserved.
          </p>
